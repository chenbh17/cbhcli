...
def print_help():
    ...
    print("")
    print("  QQ Bot 管理:")
    print("    /qqbot add <名称> <AppID> <Secret> [agent]  添加 QQ Bot")
    print("    /qqbot list                    列出所有 QQ Bot")
    print("    /qqbot start [名称]            启动 QQ Bot")
    print("    /qqbot stop [名称]             停止 QQ Bot")
    print("    /qqbot restart [名称]          重启 QQ Bot")
    print("    /qqbot status                  查看 Bot 状态")
    print("    /qqbot rm <名称>               删除 QQ Bot")
    print("    /qqbot config <名称>           修改 Bot 配置")
    print("")
    print("  其他:")
